...
let removedPart = supplyChanges.pop();
console.log('4. Removed item:', removedPart);
...
console.log(`We were able to fill ${boxes} boxes. We still have ${unboxedParts} parts left over.`)